...
red:测试代码涉及到非 runtime-core 的会直接使用 [[https://github.com/vuejs/core/tree/main/packages][core/packages at main · vuejs/core]] red:现成的代码去测试
...
green:runtime-core 的核心入口函数即 h 也就是 createVNode 函数，所以会以这个为切入点。
